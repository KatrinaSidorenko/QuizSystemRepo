...
namespace DAL.Repository
{
    public class TestRepository : BaseRepository, ITestRepository
    {
        ...
        public async Task<(int, double)> GetQuestionAmountAndPoints(int testId)
        {
        ...
        public async Task<(List<TestActivityDTO>, int)> GetUserActivityTests(int userId, Visibility? filterParam = null, int pageNumber = 1, int pageSize = 6, string orderByProp = "test_id", string sortOrder = "asc", string serachParam = null)
        {
