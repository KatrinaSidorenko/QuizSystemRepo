...
namespace BLL.Interfaces
{
    public interface IAttemptService
    {
        ...
        Task<Result<(List<AttemptHistoryDTO>, int)>> GetUserTestAttempts(int testId, int userId, SortingParam sortingParam, int? sharedTestId = null, int pageNumber = 1, int pageSize = 6, string search = "");
